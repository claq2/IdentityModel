...
namespace IdentityModel
{
    public class CryptoRandom : Random
    {
        ...
        {
            return WinRTCrypto.CryptographicBuffer.EncodeToHexString(ba);
        }
        ...
        {
            var bytes = WinRTCrypto.CryptographicBuffer.GenerateRandom(4);
        ...
        public override void NextBytes(byte[] buffer)
        {
            ...
            var bytes = WinRTCrypto.CryptographicBuffer.GenerateRandom(buffer.Length);
            WinRTCrypto.CryptographicBuffer.CopyToByteArray(bytes, out buffer);
        }
    }
}
